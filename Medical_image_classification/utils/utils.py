...
def mkdir(path):
    ...
    :param path: str -> 'c:/dataset/train' : path to create directory
    :return: None
    """
...
def get_all_directory(path):
    """
    This function is generally use to get the all the directory.
    :param path: str -> 'data/category'
    :return: list -> ['directory1', 'directory2', ..] : return directories from the given path.
    """
    files_list = []
